...
psi = ff.fit(method='jacobi', K=20, alpha=0.0, beta=0.0, reg=1e-2, damp='jackson', plot=True)
...
m1, m2 = ff.stieltjes(p=1, q=1, plot=True)

# Decompress spectral density corresponding to a larger matrix
